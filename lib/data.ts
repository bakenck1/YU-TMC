...
export const items: InventoryItem[] = [
  ...
  { id: "15", name: "Моноблок HP Demo responsible person", inventoryNumber: "2411/0164", category: "Компьютеры", location: "32 мкр / D107", responsible: "", status: "active", photoColor: "#0ea5e9", qrCode: "2411/0164", itemType: "Моноблок", brandModel: "HP Demo responsible person", displayStatus: "Работник", updatedAt: "01 окт 2025", quantity: 1, price: 250000 },
