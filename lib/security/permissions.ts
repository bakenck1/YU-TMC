...
export const APP_PERMISSIONS = [
  ...
  "inventory.local_barcode.transfer",
  "inventory.local_barcode.read_all",
  "inventory.local_barcode.read_assigned",
  "inventory.local_barcode.cancel",
...
export const PERMISSION_ROLES = {
  ...
  "inventory.local_barcode.read_assigned": EMPLOYEE_ONLY,
