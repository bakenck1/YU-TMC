...
export const EmployeeItemsTabsStory: Story = { name: "EmployeeItemsTabs", render: () => <EmployeeItemsTabs items={items.slice(0, 5)} searchHistoryScope="storybook" columnSettingsScope="storybook" actorUserId="user-1" actorRole="employee" recipientName="Demo User 1" /> };
...
export const EmployeeItemsTabPanelsStory: Story = { name: "EmployeeItemsTabPanels", render: () => <EmployeeItemsTabPanels activeStatus="active" items={items.slice(0, 5)} searchHistoryScope="storybook" columnSettingsScope="storybook" actorUserId="user-1" actorRole="employee" recipientName="Demo User 1" /> };
export const EmployeeItemsTabsViewStory: Story = { name: "EmployeeItemsTabsView", render: () => <EmployeeItemsTabsView activeStatus="active" items={items.slice(0, 5)} ariaLabel="ТМЦ сотрудника" label={(status) => status} onSelect={() => undefined} searchHistoryScope="storybook" columnSettingsScope="storybook" actorUserId="user-1" actorRole="employee" recipientName="Demo User 1" /> };
...
export const InventoryInvoiceActionsStory: Story = { name: "InventoryInvoiceActions", render: () => <InventoryInvoiceActions items={[item]} recipientName="Demo User 1" /> };
