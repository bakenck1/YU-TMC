...
| 2 | P0 | [Asset-loss vertical slice](11-p0-asset-loss-vertical-slice.md) | Даёт тесты и атомарность финансово значимому workflow | L |
| 3 | P1 | [Периметр внешних API](12-p1-external-api-boundaries.md) | Выравнивает Dockflow/1С auth, errors, limits и observability | M |
